...
Detailed feature docs live in [`src/CLAUDE.md`](src/CLAUDE.md).
...
- [`public/`](public/CLAUDE.md) — static assets
- [`src/`](src/CLAUDE.md) — React application source

## Up / down

- Parent: [`../CLAUDE.md`](../CLAUDE.md)
- Children: [`public/`](public/CLAUDE.md) · [`src/`](src/CLAUDE.md)
