 ...
 * Props: RegionTablePaginationProps (contract: .planning/regions/SPEC.md + types/admin/region-ui.ts).
 *
 * Renders:
...
import type { RegionTablePaginationProps } from "@/types/admin/region-ui"
...
export function RegionTablePagination({
  meta,
  isLoading,
  onPageChange,
  onLimitChange,
