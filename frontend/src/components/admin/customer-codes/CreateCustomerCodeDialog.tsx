...
export function CreateCustomerCodeDialog({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const trimmed: CreateCustomerCodeInput = {
      ...
      ship_to_2: form.ship_to_2?.trim() || null,
      ship_to_customer_2: form.ship_to_customer_2?.trim() || null,
      ship_to_city: form.ship_to_city?.trim() || null,
      rake: form.rake?.trim() || null,
