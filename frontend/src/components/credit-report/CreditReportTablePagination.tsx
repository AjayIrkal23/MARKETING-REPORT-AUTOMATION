 ...
 * Props: CreditReportTablePaginationProps (types/credit-report/credit-report-ui.ts).
 *
 * Renders:
 ...
 *   - Prop is `isLoading` (NOT `loading`).
 *   - Plural label: "credit record" / "credit records".
 *   - File ≤ 250 lines; verbatimModuleSyntax (import type).
 */

import type { CreditReportTablePaginationProps } from "@/types/credit-report/credit-report-ui"
...
export function CreditReportTablePagination({
  meta,
  isLoading,
  onPageChange,
  onLimitChange,
}: CreditReportTablePaginationProps) {
      ...
      <span className="shrink-0 tabular-nums">
        {isLoading || meta === null ? (
          ...
          <>
            ...
            {total === 1 ? "credit record" : "credit records"}
          </>
        )}
      </span>
