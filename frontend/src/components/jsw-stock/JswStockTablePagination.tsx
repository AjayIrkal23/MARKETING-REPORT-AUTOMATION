 ...
 * Props: JswStockTablePaginationProps (contract: .planning/jsw-stock/SPEC.md §3
 * + ADDENDUM FE-3 + types/jsw-stock/stock-ui.ts).
 *
 * Renders:
 ...
 *   - Prop is `isLoading` (NOT `loading`) — ADDENDUM FE-3.
 *   - Plural label: "stock row" / "stock rows".
 *   - File ≤ 250 lines; verbatimModuleSyntax (import type).
 */

import type { JswStockTablePaginationProps } from "@/types/jsw-stock/stock-ui"
...
export function JswStockTablePagination({
  meta,
  isLoading,
  onPageChange,
  onLimitChange,
